...
<body>
<form action="write_r.jsp" method="post" enctype="multipart/form-data">
<table>
<tr><td>작성자</td><td><input type="text" name="id" readonly="readonly" value="<%=((MbDTO)session.getAttribute("mb")).getId()%>"></td></tr>
<tr><td>제목</td><td><input type="text" name="title"></td></tr>
<tr><td>파일</td><td><input type="file" name=f1></td></tr>
<tr><td>파일</td><td><input type="file" name=f2></td></tr>
